module TD::Types
  # A photo message.
  #
  # @attr photo [InputFile] Photo to send.
  # @attr thumbnail [InputThumbnail] Photo thumbnail to be sent, this is sent to the other party in secret chats only.
  ...
  # @attr caption [FormattedText] Photo caption; 0-GetOption("message_caption_length_max") characters.
