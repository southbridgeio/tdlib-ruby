module TD::Types
  # An audio message.
  #
  # @attr audio [InputFile] Audio file to be sent.
  # @attr album_cover_thumbnail [InputThumbnail] Thumbnail of the cover for the album, if available.
  ...
  # @attr caption [FormattedText] Audio caption; 0-GetOption("message_caption_length_max") characters.
