module TD::Types
  # A video message.
  #
  # @attr video [InputFile] Video to be sent.
  # @attr thumbnail [InputThumbnail] Video thumbnail, if available.
  ...
  # @attr caption [FormattedText] Video caption; 0-GetOption("message_caption_length_max") characters.
