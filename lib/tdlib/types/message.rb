module TD::Types
  ...
  # @attr sending_state [MessageSendingState] Information about the sending state of the message; may be null.
  ...
  # @attr forward_info [MessageForwardInfo] Information about the initial message sender; may be null.
  ...
  # @attr content [MessageContent] Content of the message.
  # @attr reply_markup [ReplyMarkup] Reply markup for the message; may be null.
  class Message < Base
