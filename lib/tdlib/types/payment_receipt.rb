module TD::Types
  ...
  # @attr invoice [Invoice] Contains information about the invoice.
  # @attr order_info [OrderInfo] Contains order information; may be null.
  # @attr shipping_option [ShippingOption] Chosen shipping option; may be null.
