module TD::Types
  ...
  # @attr text [FormattedText] Game text, usually containing scoreboards for a game.
  # @attr description [String] Game description.
  # @attr photo [Photo] Game photo.
  # @attr animation [Animation] Game animation; may be null.
  class Game < Base
