module TD::Types
  ...
  #
  # @attr png_sticker [InputFile] PNG image with the sticker; must be up to 512 kB in size and fit in a 512x512 square.
  # @attr emojis [String] Emoji corresponding to the sticker.
  # @attr mask_position [MaskPosition] For masks, position where the mask should be placed; may be null.
