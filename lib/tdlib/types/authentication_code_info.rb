module TD::Types
  ...
  # @attr type [AuthenticationCodeType] Describes the way the code was sent to the user.
  # @attr next_type [AuthenticationCodeType] Describes the way the next code will be sent to the user; may be null.
